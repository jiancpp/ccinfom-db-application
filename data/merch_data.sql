...
(8, 'ENHYPEN X Dunkin'' Tumbler', 2, 2, 2, '450 ML tumbler with ENHYPEN x Dunkin’ design', 750, 500, 500),
(9, 'ENHYPEN X Dunkin'' Tote Bag', 2, 2, 2, 'Eco tote bag featuring Dunkin’ logo and members', 450, 500, 500),
(10, 'ENHYPEN X Dunkin'' Tin Case', 2, 2, 2, 'Metal tin case for storing photocard sets', 250, 500, 500),
(11, 'ENHYPEN X Dunkin'' Collector''s Set', 2, 2, 2, 'Complete set with photocard, tote, and tumbler', 1000, 600, 600),
(12, 'ZB1 Hi-Five Polaroid Set', 3, 3, 3, 'Instant film set with members’ printed signatures', 600, 400, 400),
(13, 'ZB1 Keyring', 3, 3, 3, 'Official ZB1 acrylic keyring with nameplate', 1000, 700, 700),
